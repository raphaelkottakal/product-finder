export default {
	...
	oneD: {
		...
		options: [
			{
				key: 'Point Guard',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/point_guard1.png',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/point_guard.png',
				optionText: 'Point Guard',
			},
			{
				key: 'Shooting Guard',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480568430/SIS/shoe-finder/shooting_guard1.png',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567692/SIS/shoe-finder/shooting_guard.png',
				optionText: 'Shooting Guard',
			},
			{
				key: 'Center',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/center1.png',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/center.png',
				optionText: 'Center',
			},
			{
				key: 'Power Forward',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/power_forward.png',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480568489/SIS/shoe-finder/power_forward1.png',
				optionText: 'Power Forward',
			},
			{
				key: 'Small Forward',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/smallforward1.png',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/smallforward.png',
				optionText: 'Small Forward',
			},
			{
				key: 'Skip',
				select: 'http://res.cloudinary.com/myntra-com/image/upload/v1480508269/SIS/shoe-finder/skip-selectpng.png',
				image: 'http://res.cloudinary.com/myntra-com/image/upload/v1480567693/SIS/shoe-finder/skipnew.png',
			},
		]
	},
	oneE: {
